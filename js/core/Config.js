const AppParams = {
    ...
    colors: {
        categories: {
            ...
            'Investimento': 'bg-indigo-600',
            'Mercado': 'bg-emerald-600',
            'Restaurante': 'bg-amber-500',
            'Festa': 'bg-amber-400',
            'Bar': 'bg-amber-400',
            'Airbnb': 'bg-amber-600',
            'Lojas': 'bg-indigo-500',
            'Streaming': 'bg-indigo-300',
            'Sem Parar': 'bg-blue-500',
            'Farmácia': 'bg-emerald-400',
            'Ingresso': 'bg-amber-400',
            'Serviços': 'bg-blue-600',
            'Academia': 'bg-emerald-400'
        },
